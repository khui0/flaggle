...
{#if page.url.pathname === "/"}
  ...
  <div
    in:fade
    out:fade
    class="fixed inset-0 z-10 flex flex-col items-center justify-center gap-5 p-10"
  >
    <div class="flex items-center gap-5">
      <enhanced:img
        src="$lib/assets/branding/flaggle.svg"
        class="h-19 w-19 drop-shadow-lg drop-shadow-black/50"
        alt="Flaggle icon"
      />
      <h1 class="font-title text-8xl leading-none text-shadow-black/50 text-shadow-lg">Flaggle</h1>
    </div>
